...
Source0  : https://download.savannah.nongnu.org/releases/xlog/xlog-2.0.25.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/xlog/xlog-2.0.25.tar.gz.sig
Source2  : 1903030B4FDDF9A0.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 1903030B4FDDF9A0' gpg.status
%setup -q -n xlog-2.0.25
cd %{_builddir}/xlog-2.0.25
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727134849
...
cp %{_builddir}/xlog-%{version}/COPYING %{buildroot}/usr/share/package-licenses/xlog/a6adc13d0c809ab8cb68e6e3b6eb7571bd0e2920 || :
cp %{_builddir}/xlog-%{version}/data/doc/manual/license.dox %{buildroot}/usr/share/package-licenses/xlog/b38b0c6cc916b2162c027d074710f8dfb1411711 || :
cp %{_builddir}/xlog-%{version}/data/doc/manual/output/html/license.html %{buildroot}/usr/share/package-licenses/xlog/b2eeff27106b7c09693886cfa0aa14980c04ed47 || :
export GOAMD64=v2
GOAMD64=v2
%make_install
%find_lang xlog
...
/usr/share/icons/hicolor/scalable/apps/xlog.svg
