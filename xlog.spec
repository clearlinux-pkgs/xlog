...
Source0  : https://download.savannah.nongnu.org/releases/xlog/xlog-2.0.24.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/xlog/xlog-2.0.24.tar.gz.sig
...
%prep
%setup -q -n xlog-2.0.24
cd %{_builddir}/xlog-2.0.24
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633366625
...
cp %{_builddir}/xlog-2.0.24/COPYING %{buildroot}/usr/share/package-licenses/xlog/a6adc13d0c809ab8cb68e6e3b6eb7571bd0e2920
cp %{_builddir}/xlog-2.0.24/data/doc/manual/license.dox %{buildroot}/usr/share/package-licenses/xlog/b38b0c6cc916b2162c027d074710f8dfb1411711
cp %{_builddir}/xlog-2.0.24/data/doc/manual/output/html/license.html %{buildroot}/usr/share/package-licenses/xlog/b2eeff27106b7c09693886cfa0aa14980c04ed47
%make_install
%find_lang xlog
