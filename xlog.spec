...
Version  : 2.0.14
Release  : 1
URL      : http://download.savannah.nongnu.org/releases/xlog/xlog-2.0.14.tar.gz
Source0  : http://download.savannah.nongnu.org/releases/xlog/xlog-2.0.14.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1509140435
